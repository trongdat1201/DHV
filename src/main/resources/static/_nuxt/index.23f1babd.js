import { _ as p } from "./AppBreadcrumb.vue.b9aa66bd.js";
import { _ as s, a as _ } from "./MainSection.e4d78034.js";
import { _ as a } from "./entry.8aa394d7.js";
import {
  Q as e,
  a0 as m,
  a4 as i,
...
function x(t, n) {
  const o = s;
  return (e(), m(o, i(c(t.$attrs)), null, 16));
}
const g = a($, [["render", x]]),
  B = {};
function F(t, n) {
...
const P = a(B, [["render", F]]),
  J = u({
    __name: "index",
    setup(t) {
      return (n, o) => (
        e(),
        l(d, null, [r(p), f("div", null, [r(g), r(P)])], 64)
      );
    },
  });
export { J as default };

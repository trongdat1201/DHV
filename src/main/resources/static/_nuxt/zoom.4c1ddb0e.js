import { K as o } from "./entry.8aa394d7.js";
import { i as f } from "./motion.d46d0bbf.js";
const c = new o("antZoomIn", {
  ...
  I = {
    zoom: { inKeyframes: c, outKeyframes: y },
    "zoom-big": { inKeyframes: a, outKeyframes: s },
    "zoom-big-fast": { inKeyframes: a, outKeyframes: s },
    "zoom-left": { inKeyframes: l, outKeyframes: u },
    "zoom-right": { inKeyframes: p, outKeyframes: z },
    "zoom-up": { inKeyframes: g, outKeyframes: O },
    "zoom-down": { inKeyframes: K, outKeyframes: w },
  },
  h = (n, r) => {
    const { antCls: m } = n,
      t = `${m}-${r}`,
      { inKeyframes: i, outKeyframes: e } = I[r];
    return [
      f(
        t,
        i,
        e,
        r === "zoom-big-fast" ? n.motionDurationFast : n.motionDurationMid
      ),
      {
        [`
        ${t}-enter,

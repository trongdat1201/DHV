...
async function P(t, a = S()) {
  const { path: o, matched: e } = a.resolve(t);
  if (
    !e.length ||
    (a._routePreloaded || (a._routePreloaded = new Set()),
    a._routePreloaded.has(o))
  )
    return;
  const r = (a._preloadPromises = a._preloadPromises || []);
  if (r.length > 4) return Promise.all(r).then(() => P(t, a));
  a._routePreloaded.add(o);
  const i = e
    .map((n) => {
      var s;
  ...
  for (const n of i) {
    const s = Promise.resolve(n())
      .catch(() => {})
      .finally(() => r.splice(r.indexOf(s)));
    r.push(s);
  }
  await Promise.all(r);
}
const U = (...t) => t.find((a) => a !== void 0),
  V = "noopener noreferrer";
/*! @__NO_SIDE_EFFECTS__ */ function j(t) {
  const a = t.componentName || "NuxtLink",
    o = (e, r) => {
      if (!e || (t.trailingSlash !== "append" && t.trailingSlash !== "remove"))
        return e;
      const i = t.trailingSlash === "append" ? T : A;
      if (typeof e == "string") return i(e, !0);
      const n = "path" in e ? e.path : r(e).path;
      return { ...e, name: void 0, path: i(n, !0) };
    };
  return w({
    name: a,
    props: {
    ...
    setup(e, { slots: r }) {
      const i = S(),
        ...
        s = x(() =>
          e.external || (e.target && e.target !== "_self")
            ...
            ? !1
            : n.value === "" || k(n.value, { acceptRelative: !0 })
        ),
        v = C(!1),
        f = C(null),
        b = (l) => {
          ...
          O(() => {
            h = g(() => {
              ...
              (m = f == null ? void 0 : f.value) != null &&
                m.tagName &&
                (u = p.observe(f.value, async () => {
                  u == null || u(), (u = null);
                  const c =
                    typeof n.value == "string"
                      ? n.value
                      : i.resolve(n.value).fullPath;
                  await Promise.all([
                    d.hooks.callHook("link:prefetch", c).catch(() => {}),
                    !s.value && P(n.value, i).catch(() => {}),
                  ]),
                    (v.value = !0);
                }));
            });
      ...
      return () => {
        ...
        if (!s.value) {
          ...
          return (
            e.custom ||
              (v.value && (c.class = e.prefetchedClass || t.prefetchedClass),
              (c.rel = e.rel)),
            _(L("RouterLink"), c, r.default)
          );
        }
        const l =
            typeof n.value == "object"
              ? ((p = i.resolve(n.value)) == null ? void 0 : p.href) ?? null
              : n.value || null,
          d = e.target || null,
          h = e.noRel
            ? null
            : U(e.rel, t.externalRelAttribute, l ? V : "") || null,
          u = () => N(l, { replace: e.replace });
        return e.custom
          ? r.default
            ? r.default({
                href: l,
...
const F = j({ componentName: "NuxtLink" });
function D() {
  const t = y();

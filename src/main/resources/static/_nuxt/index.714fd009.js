import { _ as i } from "./AppBreadcrumb.vue.5ade005c.js";
import { _, a as s, b as a } from "./NewsEvent.vue.24b295cf.js";
...
import "./AppNewsEvent.e529aabe.js";
...
const E = c(g, [["render", h]]),
  F = {};
function P(o, n) {
  const t = a;
  return (r(), m(t));
}
const B = c(F, [["render", P]]),
  C = { class: "bg-light-blue" },
  tt = p({
    __name: "index",
    setup(o) {
      return (n, t) => (
        r(),
        u(d, null, [e(i), e($), e(E), f("div", C, [e(B)])], 64)
      );
    },
  });

import { n } from "./swiper-vue.d5cda4d1.js";
const o = (t) => ({
    [t.componentCls]: {
...
const r = function () {
    ...
    return {
      ...
      css: !0,
      onBeforeEnter: (s) => {
        (s.style.height = "0px"), (s.style.opacity = "0"), a(s, t);
      },
      onEnter: (s) => {
        n(() => {
      ...
      onAfterEnter: (s) => {
        s && (l(s, t), (s.style.height = null), (s.style.opacity = null));
      },
      onBeforeLeave: (s) => {
        a(s, t),
      ...
      onAfterLeave: (s) => {
        s &&
          (l(s, t),
          s.style && ((s.style.height = null), (s.style.opacity = null)));
      },
    };
  },
  p = r;
export { p as c, u as g };

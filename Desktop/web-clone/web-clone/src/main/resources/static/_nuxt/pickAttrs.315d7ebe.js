import { a as i } from "./entry.8aa394d7.js";
const e = {
    MAC_ENTER: 3,
    BACKSPACE: 8,
    TAB: 9,
    ...
    isTextModifyingKeyEvent: function (a) {
      const { keyCode: n } = a;
      if ((a.altKey && !a.ctrlKey) || a.metaKey || (n >= e.F1 && n <= e.F12))
        return !1;
      switch (n) {
        case e.ALT:
        case e.CAPS_LOCK:
...
summary tabindex target title type usemap value width wmode wrap`,
  l = `onCopy onCut onPaste onCompositionend onCompositionstart onCompositionupdate onKeydown
...
function S(t) {
  ...
  return (
    Object.keys(t).forEach((o) => {
      ((n.aria && (o === "role" || c(o, u))) ||
        (n.data && c(o, d)) ||
        (n.attr && (r.includes(o) || r.includes(o.toLowerCase())))) &&
        (s[o] = t[o]);
    }),
    s
  );
}
export { M as K, S as p };

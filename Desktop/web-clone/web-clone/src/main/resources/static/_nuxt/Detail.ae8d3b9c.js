import { u as P, _ as $ } from "./Detail.f8923e16.js";
import { _ as i, L as C } from "./entry.8aa394d7.js";
import { _ as y } from "./AppBreadcrumb.vue.7e47a49f.js";
import {
  _ as F,
  a as h,
  b as T,
...
const D = l({
    ...
    setup(o) {
      return (e, t) => {
        const p = F;
        return n(), m(p, { data: o.data }, null, 8, ["data"]);
      };
    },
  }),
  O = {};
...
const k = i(O, [["render", S]]),
  L = {};
function I(o, e) {
  const t = T;
  return n(), m(t);
}
const R = i(L, [["render", I]]),
  W = {};
function A(o, e) {
  const t = b;
  return n(), m(t);
}
const w = i(W, [["render", A]]),
  M = {};
function N(o, e) {
  const t = E;
  return n(), m(t);
}
const Q = i(M, [["render", N]]),
  V = {};
function q(o, e) {
  const t = j;
  return n(), m(t);
}
const G = i(V, [["render", q]]),
  H = l({
    __name: "Detail",
    setup(o) {
      const {
          ...
          careerProspects: p,
          curriculum: d,
          specializedTraining: f,
        } = P(),
        g = B(() => {
          var _, u;
          return [
            {
              name: (_ = e.value) == null ? void 0 : _.name,
              name_en: (u = e.value) == null ? void 0 : u.name_en,
            },
          ];
        });
      return (_, u) => {
        ...
        return (
          ...
          v(
            ...
            null,
            [
              r(y, { "extra-last-breadcrumb": a(g) }, null, 8, [
                "extra-last-breadcrumb",
              ]),
              r(x, null, {
                banner: c(() => [r(D, { data: a(e) }, null, 8, ["data"])]),
                careerProspects: c(() => [
                  r(
                    k,
                    {
                      description: ("getFieldWithLocale" in _
                ...
                careerOpportunities: c(() => [
                  r(R, { data: a(t) }, null, 8, ["data"]),
                ]),
                specializedTraining: c(() => {
                  var s;
                  return [
                    r(
                      w,
                      {
                        data:
                          ((s = a(f)) == null ? void 0 : s.majorSectionItems) ||
                          [],
                      },
                      null,
                      8,
                ...
                curriculum: c(() => {
                  ...
                  return [
                    r(
                      ...
                      {
                        "list-study-program":
                          ((s = a(d)) == null ? void 0 : s.majorSectionItems) ||
                          [],
                      },
                      null,
                      8,
                ...
                register: c(() => [r(G, { data: a(e) }, null, 8, ["data"])]),
                _: 1,
              }),
            ],
            64
...
const Dt = i(H, [["__scopeId", "data-v-2d800d2c"]]);
